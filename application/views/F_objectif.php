                        ...
                        <div class="col mb-4">
                            <div class="card shadow-sm">
                                <div class="card-body px-4 py-5 px-md-5">
                                    ...
                                    <h5 class="fw-bold card-title">Votre Poid Actuel: <?php echo $client->poids; ?> Kg</h5>
                                    <p class="text-muted card-text mb-4">Commencez votre regime!
                                    </br>
                                        Veuillez choisir vos objectifs
                                    </p>
                                    </p>
                                    <form method="post" action="<?php echo base_url('F_Objectif_C/ajoutObjectif'); ?>">
                                        <input type="number" class="form-control" placeholder="Entrez votre objectif" name="objectif" id="objectif" style="margin-bottom:15px">
                                        <input type="hidden" value="<?php echo $this->session->userdata('userid'); ?>" class="form-control" placeholder="Entrez votre objectif" name="id_client" style="margin-bottom:15px">                                       
                                        <input type="submit" class="btn btn-primary shadow" value="OK">
                                    </form>
                                </div>
                            </div>
                        </div>
