...
<body>
    ...
    <section>
        <div class="container bg-primary-gradient py-12">
            <div class="py-12 p-lg-12">
                <div class="row row-cols-1 row-cols-md-12 mx-auto" style="max-width: 900px;">
                    <div class="col mb-12">
                        <div class="card shadow-sm">
                            <div class="card-body px-12 py-12 px-md-12" style="height: 650px; text-align: center;">
                                ...
                                <div class="card-body">
                                <h5 class="fw-bold card-title" style="background-color: lightseagreen;">Votre regime alimentaire:</h5>

                                    <p>Pour pouvoir perdre ... kg , vous devez prendre ce regime pendant ..</p>
                                ...
                                <h5 class="fw-bold card-title" style="background-color: lightseagreen;">Votre regime Sportive:</h5>
                                </br>
                                <p>Faire du ... , ... mn par jour</p>
                                <p><button class="btn btn-primary shadow" type="button">Retour vers la page d'accueil</button></p>
                            </div>
                        </div>
                    </div>
                </div>
