...
<body>
    ...
    <section class="py-1">
        <div class="container text-center py-5">
            <p class="mb-4" style="font-size: 1.6rem;"><h3>Voulez-vous du changement ?</h3></p>
        </div>
    </section>
    <section>
                ...
                <div class="row row-cols-1 row-cols-md-12 mx-auto" style="max-width: 900px;">
                    <div class="col mb-12">
                        <div class="card shadow-sm">
                            <div class="card-body px-12 py-12 px-md-12" style="height: 250px; text-align: center;">
                                ...
                                <h5 class="fw-bold card-title">Votre poids actuel est : ...</h5>
                                </br>
                                <p class="text-muted card-text mb-4">Votre poids objectif <input type="text" name="poids" style="border-top: none; border-left: none; border-right: none;"></p>
                                </br>
                                <p><button class="btn btn-primary shadow" type="button">Valider</button></p>
                            </div>
                        </div>
                    </div>
                </div>
